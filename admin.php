...
case 'logout' :
	...
	if ( ! empty( $_REQUEST['redirect_to'] ) ) {
		...
		$redirect_to = 'admin.php?loggedout=true';
...
<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( 'admin.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
	<p>
...
?>
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( network_site_url( 'admin.php?action=resetpass', 'login_post' ) ); ?>" method="post" autocomplete="off">
...
?>
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url( 'admin.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
	<p>
